    ...
    public Team getMyTeam() {
        ...
        try {
            ...
            if (responseBody.getInt("status_code") == 200) {
                ...
                Object[] teamListObj = (teamJSON.getJSONArray("members").toList().toArray());
                String[] teamList = new String[teamListObj.length];
                for (int i = 0; i < teamListObj.length; i++) {
                    teamList[i] = (String)teamListObj[i];
                }
